...
class Swiper extends Component {
  ...
  pushCardToStack = (renderedCards, index, position, key, firstCard) => {
    ...
    const overlayExist =
      !!overlayLabels &&
      !!overlayTypeOnSwipeCard &&
      !!overlayLabels[overlayTypeOnSwipeCard];
    const dynamicStyle = overlayExist
      ? overlayLabels[overlayTypeOnSwipeCard].style
      : null;
    const dynamicWrapperStyle = dynamicStyle ? dynamicStyle.wrapper : {};
    ...
    renderedCards.push(
      ...
      >
        ...
        {overlayExist && firstCard ? (
          <View
            style={[this.props.overlayLabelWrapperStyle, dynamicWrapperStyle]}
          >
